...
export function useClientes() {
  ...
  async function registrarAbono(
    ...
    // El RPC valida (monto > 0, monto <= deuda_actual, caja abierta y propia)
    // y — si se indica una caja — acredita el cobro a esa sesion, todo en
    // una unica transaccion atomica en el servidor.
